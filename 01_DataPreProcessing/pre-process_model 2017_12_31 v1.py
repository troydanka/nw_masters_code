...
def processCovariates(DSI_doc_output):
    ...
    business_rule1 = ['regulation', 'regulatory']
    
    try:
        for businessrule in business_rule1:
            
            if businessrule in temp_string:
    ...
    business_rule3 = ['ai', 'artificial intelligence', 'machine learning', 'data science']
...
def organizeCorpusDSIs(inputDirPath):
    ...
    for DSI_filename in temp_file_list:
        ...
        if re.search("FRB_Speech" , DSI_filename):
            ...
            DSI_doc_output["dsi_title"] = DSI_doc["speech_title"]
            DSI_doc_output["dsi_date"] = DSI_doc["speech_date"]   ## Need to work on a date time transformation
            DSI_doc_output["dsi_source"] = "FRB"
            DSI_doc_output["dsi_author"] = DSI_doc["speech_speaker"]
            DSI_doc_output["dsi_type"] = "FRB_Speech"
            DSI_doc_output["dsi_location"] = DSI_doc["speech_location"]
            DSI_doc_output["dsi_content_sponsor"] = "NA"
            DSI_doc_output["dsi_content"] = DSI_doc["speech_content"]
            DSI_doc_output["dsi_aggregated_content"] = DSI_doc["speech_content"] ## DSI_doc["speech_title"] + " "
            ...
            DSI_doc_output["dsi_aggregated_content"] = DSI_doc_output["dsi_content"] ## DSI_doc["speech_title"] + " " 
...
def buildCorpusStatsDF(dataCorpus, file_name):
    ...
    labels = ['DSINUM','DSI_Type', 'DSI_TIMESTAMP', 'DSI_SOURCE', 'DSI_AUTHOR', 'DSI_TITLE', 'DSI_LOCATION', 'DSI_SPONSOR']
    ...
    for DSI_doc in dataCorpus:
        ...
        try:
            dsi_record = [dsi_count,DSI_doc["dsi_type"],DSI_doc["dsi_date"],DSI_doc["dsi_source"],DSI_doc["dsi_author"],DSI_doc["dsi_title"],DSI_doc["dsi_location"],DSI_doc["dsi_content_sponsor"] ]  
